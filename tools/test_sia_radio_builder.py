...
# Regression DEV0.4.1.7: deterministic direct-DVD fallback retained.
...
print("Tests fallback DVD DEV0.4.1.7 OK")

# Regression DEV0.4.1.7: the Atlas VAC catalogue can be complete while chart
...
print("Tests eAIP AD 2.18 DEV0.4.1.7 OK")
...
print("Tests priorité colonne Service DEV0.4.1.7 OK")
...
print("Tests sélection source eAIP HTML DEV0.4.1.7 OK")
