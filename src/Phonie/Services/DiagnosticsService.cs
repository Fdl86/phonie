...
public sealed class DiagnosticsService : IAsyncDisposable
{
    ...
    public DiagnosticsService()
    {
        ...
        this.SessionFilePath = Path.Combine(this.DirectoryPath, $"PHONIE-DEV0.3.0.3-{DateTime.Now:yyyyMMdd-HHmmss}.log");
    ...
    private void WriteHeader()
    {
        lock (this.syncRoot)
        {
            this.writer.WriteLine("# PHONIE DEV0.3.0.3 - LOG DIAGNOSTIC DE LÉGÈRETÉ");
