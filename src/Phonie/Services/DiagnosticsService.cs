...
public sealed class DiagnosticsService : IAsyncDisposable
{
    ...
    public DiagnosticsService()
    {
        ...
        this.SessionFilePath = Path.Combine(this.DirectoryPath, $"PHONIE-DEV0.4.0.1-{DateTime.Now:yyyyMMdd-HHmmss}.log");
    ...
    private void WriteHeader()
    {
        lock (this.syncRoot)
        {
            this.writer.WriteLine("# PHONIE DEV0.4.0.1 - LOG DIAGNOSTIC DE LÉGÈRETÉ");
