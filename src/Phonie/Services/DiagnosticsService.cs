...
public sealed class DiagnosticsService : IAsyncDisposable
{
    ...
    public DiagnosticsService()
    {
        ...
        this.SessionFilePath = Path.Combine(this.DirectoryPath, $"PHONIE-DEV0.4.1.9-{DateTime.Now:yyyyMMdd-HHmmss}.log");
    ...
    private void WriteHeader()
    {
        lock (this.syncRoot)
        {
            this.writer.WriteLine("# PHONIE DEV0.4.1.9 - LOG DIAGNOSTIC DE LÉGÈRETÉ");
