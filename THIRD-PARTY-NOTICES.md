...
PHONIE DEV0.3.0 utilise :

- `SimConnect.NET` 0.2.1 - licence MIT ;
- `NAudio` 2.3.0 - licence MIT ;
- `Whisper.net` 1.7.4 - licence MIT ;
- `Whisper.net.Runtime` 1.7.4 - runtime natif whisper.cpp ;
- modèle `ggml-small-q5_1.bin` téléchargé séparément depuis le dépôt de modèles whisper.cpp.
